...
public class Gui extends JFrame implements
        ...
        MenuPanel.OnManualButtonClickListener,
        ManualPanel.OnBackMenuButtonClickListener{
    ...
    private void initComponent() {
        ...
        menuPanel.setOnManualButtonClickListener(this);
    ...
    public void onManualButtonClicked() {
        ...
        manualPanel.requestFocus();
        manualPanel.setOnBackMenuButtonClickListener(this);
        add(manualPanel);
        validate();
    }
